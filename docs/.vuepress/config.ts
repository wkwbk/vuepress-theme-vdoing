...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    logo: 'https://img.wkwbk.eu.org/i/favicon.png', // 导航栏logo
    // repo: 'wkwbk', // 导航栏右侧生成Github链接
    ...
    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://img.wkwbk.eu.org/i/avatar.png',
      name: 'LI SIR',
      slogan: 'Remember me.',
    },
  ...
  head: [
    ['link', { rel: 'icon', href: 'https://img.wkwbk.eu.org/i/favicon.png' }], //favicons，资源放在public文件夹
    [
      'meta',
      {
        name: 'keywords',
