...
const DOMAIN_NAME = 'blog.lisir.me' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        link: '/exam/',
        items: [
          { text: '软考中级', link: '/pages/c33a86/' },
          { text: '计算机二级', link: '/pages/ba0dde/' },
        ],
      },
      {
        text: '科学上网',
        link: '/proxy/',
        items: [
          { text: '介绍', link: '/pages/aa5192/' },
          { text: '搭建', link: '/pages/55a70e/' },
          { text: '使用', link: '/pages/45d335/' },
        ],
      },
      {
        text: '设计模式',
    ...
    logo: 'https://img.lisir.me/image/my/favicon.png', // 导航栏logo
    // repo: 'wkwbk/vuepress-theme-vdoing', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'LI SIR', // 必需
      link: 'https://github.com/wkwbk', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'By <a href="https://blog.lisir.me" target="_blank">LI SIR</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: 'LI SIR,个人博客,个人技术博客,技术文档,学习,面试,git,github,markdown',
      },
    ],
